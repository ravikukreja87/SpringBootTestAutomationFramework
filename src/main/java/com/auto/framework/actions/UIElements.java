...
/************************************************************************************************************************
 * @Author : Ravi Kukreja
 * @Description : Selenium UI Elements implementation class providing comprehensive methods for web element
 *                  interactions including clicking, typing, navigation, nested menu handling, relative locators,
 *                  and table interactions. This class extends ActionsBaseClass and implements IUIElements interface.
 * @Version : 1.1
 ************************************************************************************************************************/
...
public class UIElements extends ActionsBaseClass implements IUIElements {
	 ...
	 * 
	 * @param toLeftoOfBy The locator of the reference element (the element to the right)
	 ...
	 * 
	 * @param toLeftoOfBy The locator for elements to search within for the text
